...
onStart: async function({ api, event, args }) {
 ...
 return api.sendMessage("❌ | Vous n'êtes pas autorisé à utiliser cette commande, vérifiez la commande adc,", event.threadID, event.messageID);
    ...
    if(!text && !name) return api.sendMessage('Veuillez répondre au lien auquel vous souhaitez appliquer le code ou écrire le nom du fichier pour télécharger le code sur Pastebin !', threadID, messageID);
    if(!text && name) {
